...
Route::middleware(['AuthUser'])->group(function () {
    ...
    // Route::view('/blog1', 'frontend.blog1')->name('blog1');
    Route::GET('/blogs', 'MainController@blogs')->name('blogs'); 
    Route::GET('/why-a-latex-mattress-is-the-best-choice-for-healthy-&-comfortable-sleep', 'MainController@blogs1')->name('blogs1'); 
    Route::GET('/say-goodbye-to-back-pain-with-the-right-orthopedic-mattress', 'MainController@blogs2')->name('blogs2'); 
    Route::GET('/the-natural-making-of-a-100%-latex-mattress', 'MainController@blogs3')->name('blogs3'); 
    Route::GET('/why-a-dr-ortho-mattress-is-the-best-choice-for-back-pain-relief', 'MainController@blogs4')->name('blogs4'); 
    Route::GET('/what-to-look-for-in-a-mattress', 'MainController@blogs5')->name('blogs5'); 
    Route::GET('/what-is-an-orthopedic-mattress', 'MainController@blogs6')->name('blogs6'); 
    ...
    // Route::view('/product-category/pillows/fibre-pillow/', 'frontend.fibre-pillow')->name('fibre-pillow');
    ...
    Route::view('/return-and-refund', 'frontend.return-and-refund')->name('return-and-refund');

// policy

    // Route::view('/terms-and-condition', 'frontend.policy.terms-and-condition')->name('terms-and-condition');
    ...
    Route::view('/privacy-policy', 'frontend.policy.privacy-policy')->name('privacy-policy');
    Route::view('/facebook-data-deletion', 'frontend.policy.facebook-data-deletion')->name('/facebook-data-deletion');
    Route::view('/terms-conditions', 'frontend.policy.terms-conditions')->name('terms-conditions');
    Route::view('/return-refund-policy', 'frontend.policy.return-refund-policy')->name('return-refund-policy');
    Route::view('/shipping-policy', 'frontend.policy.shipping-policy')->name('shipping-policy');

// contact us

    Route::GET('/contact', 'EnquiryController@create')->name('contact');
    Route::POST('/contact', 'EnquiryController@store')->name('contact.submit');
...
// product routes
    ...
    Route::GET('/product-category/{slug}', 'MainController@getCategoryProducts')->name('cate');
...
Route::prefix('kanwarjishop')->group(function () {
