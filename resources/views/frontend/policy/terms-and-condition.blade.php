        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <ul class="breadcrumb justify-content-center">
                    ...
                    <li class="current"><span>Terms & Condition</span></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-12  col-md-12 order-md-2 mb-sm--25">
                    <div class="about-text">
                        <p class="color--light-3">The terms <span>"Vardhra Shoes"</span> <span>"We"</span> /
                            ...
                            Naturals and the terms "Visitor” ”User” refer to the users.
                        </p>
                        <p class="color--light-3">This page states the Terms and Conditions under which you (Visitor)
                            may visit this website
                            (“Website”). Please read this page carefully. If you do not accept the Terms and Conditions
                            stated here, we would request you to exit this site. The business, any of its business
                            divisions and / or its subsidiaries, associate companies or subsidiaries to subsidiaries or
                            such other investment companies (in India or abroad) reserve their respective rights to
                            revise these Terms and Conditions at any time by updating this posting. You should visit
                            this page periodically to re-appraise yourself of the Terms and Conditions, because they are
                            binding on all users of this Website.
                        </p>
                        <strong>Use Of Content</strong>
                        <p class="color--light-3">All logos, brands, marks headings, labels, names, signatures,
                        ...
                        <p class="color--light-3">You may not sell or modify the content of this Website or reproduce,
                            display, publicly
                            perform, distribute, or otherwise use the materials in any way for any public or commercial
                            purpose without the respective organisation’s or entity’s written permission.
                        </p>
                        <strong>Acceptable Website Use</strong>
                        <ul>
                            <li><strong>(A) Security Rules</strong><br>Visitors are prohibited from violating or
                                attempting to violate the security of the Web site, including, without limitation, (1)
                                accessing data not intended for such user or logging into a server or account which the
                                user is not authorised to access, (2) attempting to probe, scan or test the
                                vulnerability of a system or network or to breach security or authentication measures
                                without proper authorisation, (3) attempting to interfere with service to any user, host
                                or network, including, without limitation, via means of submitting a virus or "Trojan
                                horse" to the Website, overloading, "flooding", "mail bombing" or "crashing", or (4)
                                sending unsolicited electronic mail, including promotions and/or advertising of products
                                or services. Violations of system or network security may result in civil or criminal
                                liability. The business and / or its associate entities will have the right to
                                investigate occurrences that they suspect as involving such violations and will have the
                                right to involve, and cooperate with, law enforcement authorities in prosecuting users
                                who are involved in such violations.
                            </li>
                            <li><strong>(B) General Rules</strong><br>Visitors may not use the Web Site in order to
                                transmit, distribute, store or destroy material (a) that could constitute or encourage
                                conduct that would be considered a criminal offence or violate any applicable law or
                                regulation, (b) in a manner that will infringe the copyright, trademark, trade secret or
                                other intellectual property rights of others or violate the privacy or publicity of
                                other personal rights of others, or (c) that is libellous, defamatory, pornographic,
                                profane, obscene, threatening, abusive or hateful.
                            </li>
                        </ul>
                        <strong>Indemnity</strong>
                        <p class="color--light-3">The User unilaterally agree to indemnify and hold harmless, without
                            ...
                            from their use of <a href="http://www.vardhra.in">www.vardhra.in</a> heir breach
                            of the terms . </p>
                        ...
                        <p class="color--light-3">
                            ...
                            limited to, damages for loss of profits or/and use or/and data or other intangible, even if
                            Company has been advised of the possibility of such damages.
                        </p>
                        <p class="color--light-3">User further agrees that Company shall not be liable for any damages
                            arising from
                        ...
                        <p class="color--light-3">User agrees that Company shall not be responsible or liable to user,
                            or anyone, for the
                        ...
                        <p class="color--light-3">These conditions are governed by and construed in accordance with the
                            laws of India. You
                            agree, as we do, to submit to the exclusive jurisdiction of the courts at Mumbai [
                            Maharashtra ]
                        </p>
                        <strong>Children</strong>
                        <p class="color--light-3">vardhra.in is available only to persons who can form a legally
                            binding contract under
                            the Indian Contract Act, 1872. If you are a minor i.e. under the age of 18 years, you may
                            use vardhra.in only with the involvement of a parent or guardian.
                        </p>
                        <strong>Disclaimer Of Consequential Damages</strong>
                        <p class="color--light-3">In no event shall Company or any parties, organizations or entities
                            associated with the
