...
@section('meta_canonical'){{$category->meta_canonical}}@endsection
...
<!-- breadcrumb end -->
 @if(!is_null($category->categorydescription) && $category->categorydescription !== '')
<section class="mt-5">
    <div class="container">
        <div class="row">
            <div class="col-12">
...
@endif
<!-- grid-list start -->
<section class="section-tb-padding pt-5">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-12">
                <div class="all-filter">
                    <form action="{{ route('cate', $category->slug_url) }}" method="GET" id="searchForm">
                        ...
                        @endif
                        <div class="vendor-filter d-none">
                            <h4 class="filter-title">Thickness</h4>
                            <a href="#color" data-bs-toggle="collapse" class="filter-link"><span>Thickness
...
<!-- grid-list start -->
 @if(!is_null($category->id) && $category->id == '42')
