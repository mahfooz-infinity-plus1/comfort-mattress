        ...
        <div class="row">
            <div class="col-sm-12 main-border">
                <table class="table table-bordered table-responsive">
                    <tr class="pb-20">
                        <td colspan="2">
                            <div class="text-center">
                                <p class="company_title text-center"> Comfort Mattress </p>
                                
                                <p class="company_address"> Comfort Mattress Commercial Chamber, Yusuf Meher Ali RD, Masjid Bandra West, Masjid Bandar, MUMBAI 400003.</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2">
                            Contact: +91 7045944986
                            <span class="invoice_span">Email id : info@comfort-mattress.com</span>
                        </td>
                    </tr>
                </table>
                <table class="table table-bordered table-responsive">
                ...
                <table class="table table-bordered table-responsive mb-0">
                    ...
                    <tr>
                        <td style="width: 145px !important">
                            ...
                            {{ $detail->size ? 'Volume: ' . $detail->size->title : '' }} <br>
                            {{ $detail->color ? 'Size: ' . $detail->color->title : '' }} <br>
                        </td>
