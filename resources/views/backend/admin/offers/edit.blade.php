            ...
            <form method="post" id="formEditOffer" class="needs-validation">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="title">Title <span class="text-danger">*</span></label>
                            <input class="form-control" value="{{ old('title', $offer->title) }}" name="title" type="text" id="title" placeholder="Title" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ old('code', $offer->code) }}" name="code" type="text" id="code" placeholder="e.g. COMFORT1000" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-control" required>
                                <option value="flat" {{ $offer->type === 'flat' ? 'selected' : '' }}>Flat (₹)</option>
                                <option value="percent" {{ $offer->type === 'percent' ? 'selected' : '' }}>Percentage (%)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ old('value', $offer->value) }}" name="value" type="number" step="0.01" id="value" placeholder="e.g. 1000 or 10" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ old('min_order_amount', $offer->min_order_amount) }}" name="min_order_amount" type="number" step="0.01" id="min_order_amount" placeholder="e.g. 5000">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ old('max_uses', $offer->max_uses) }}" name="max_uses" type="number" id="max_uses" placeholder="e.g. 100">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ old('uses_per_user', $offer->uses_per_user) }}" name="uses_per_user" type="number" id="uses_per_user" placeholder="e.g. 1">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ old('start_date', $offer->start_date ? date('Y-m-d\TH:i', strtotime($offer->start_date)) : '') }}" name="start_date" type="datetime-local" id="start_date">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ old('end_date', $offer->end_date ? date('Y-m-d\TH:i', strtotime($offer->end_date)) : '') }}" name="end_date" type="datetime-local" id="end_date">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-check mt-4">
                            <input type="checkbox" name="is_active" value="1" class="form-check-input" id="is_active" {{ $offer->is_active ? 'checked' : '' }}>
