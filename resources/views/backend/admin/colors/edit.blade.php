...
<section class="section">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-dark text-white-all">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Edit Thickness</li>
            <li class="breadcrumb-item"><a href="{{ route('admin.colors.all') }}"> All Thickness</a></li>
        </ol>
    </nav>
    <div class="card">
        <div class="card-header bg-dark text-white-all">
            <h4>Update Thickness</h4>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="title">Thickness <span class="text-danger">*</span></label>
