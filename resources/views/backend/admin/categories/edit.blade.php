                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="categorydescription" id="categorydescription" rows="4" class="form-control summernote">{{old('categorydescription', $category->categorydescription) }}</textarea>
                        </div>
                    </div>
