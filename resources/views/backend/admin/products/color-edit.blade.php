...
<section class="section">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb bg-dark text-white-all">
            ...
            <li class="breadcrumb-item active" aria-current="page"><i class="fas fa-list"></i>Update Size & Price </li>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="color_id" id="color_id" class="form-control" required>
                                @foreach($colors as $color)
                                    <option value="{{ $color->id }}" {{ $cl->color_id  == $color->id ? 'selected' : '' }}>
                                        {{ $color->title }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input class="form-control" value="{{ $cl->size->title }}">
                            <input type="hidden" name="size_id" value="{{ $cl->size_id }}">
                        </div>
                    </div>
