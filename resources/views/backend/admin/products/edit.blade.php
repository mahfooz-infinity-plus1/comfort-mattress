...
@section('content')
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header bg-dark text-white-all">
                    <h5 class="modal-title" id="formModal">Add More Custom Field of {{ $product->title }}</h5>
    ...
    <div class="modal" id="addColorModal">
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                <div class="modal-header bg-dark text-white-all">
                    <h5 class="modal-title" id="formModal">Add More Thickness & Size of {{ $product->title }}</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <form action="{{ route('admin.products.add.color', $product->id) }}" method="POST" class="needs-validation"
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btnSubmit">
                            <i class="fa fa-plus"></i> Add Thickness & Size
                        </button>
                    </div>
                </form>
            </div>
                                ...
                                <select name="category_id[]" id="category_id" class="form-control select2"
                                    ...
                                    @foreach ($categories as $cate)
                                        <option value="{{ $cate->id }}"
                                            {{ in_array($cate->id, $product->categories->pluck('id')->toArray()) || $cate->id == $product->category_id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="upc" id="upc" class="form-control"
                                    value="{{ $product->upc }}" placeholder="Enter UPC">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="review_status" id="review_status" class="form-control" required>
                                    ...
                                    <option value="0" {{ $product->review_status == false ? 'selected' : '' }}>Not
                                        Available
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="wrong_products"
                                        ...
                                        {{ $product->wrong_products == true ? 'checked' : '' }}>
                                ...
                                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="faulty_products"
                                        ...
                                        {{ $product->faulty_products == true ? 'checked' : '' }}>
                                ...
                                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="quality_issue"
                                        ...
                                        {{ $product->quality_issue == true ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <img src="{{ asset($product->image_url1) }}" alt="{{ $product->title }}"
                                                width="100">
                                        </div>
                                    </div>
                                </div>
