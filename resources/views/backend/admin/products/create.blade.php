...
<section class="section">
    ...
    <div class="card" ng-app="products">
        ...
        <div class="card-body">
            <form method="POST" role="form" class="needs-validation" id="formAddProduct" enctype="multipart/form-data"
                autocomplete="off">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="category_id[]" class="form-control select2" id="category_id" multiple="multiple" required>
                                    <option value="" disabled> --Select Category--</option>
                                    @foreach($categories as $cate)
                                    <option value="{{ $cate->id }}" {{ (is_array(old('category_id')) && in_array($cate->id, old('category_id'))) ? 'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="material_id" id="material_id" class="form-control select2" required>
                                    ...
                                    <option value="{{ $material->id }}" {{ old('material_id')==$material->id ?
                                        'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="condition_id" id="condition_id" class="form-control select2">
                                    ...
                                    <option value="{{ $condition->id }}" {{ old('condition_id')==$condition->id ?
                                        'selected' : '' }}>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="warranty_id" id="warranty_id" class="form-control select2">
                                    ...
                                    <option value="{{ $warranty->id }}" {{ old('warranty_id')==$warranty->id ?
                                        'selected' : '' }}>
                                        {{ $warranty->title }}
                                    </option>
                                    @endforeach
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="weight_id" id="weight_id" class="form-control select2">
                                    ...
                                    <option value="{{ $unit->id }}" {{ old('weight_id')==$unit->id ? 'selected' : '' }}>
                                        {{ $unit->unit }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="review_status" id="review_status" class="form-control" required>
                                    ...
                                    <option value="1" {{ old('review_status')==true ? 'selected' : '' }}>Available
                                    </option>
                                    <option value="0" {{ old('review_status')==false ? 'selected' : '' }}>Not Available
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="color_id">Thickness <span class="text-danger">*</span></label>
                            ...
                            <div class="form-check form-check-inline">
                                ...
                                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="wrong_products" value="1"
                                        name="wrong_products" {{ old('wrong_products') ? 'selected' : '' }}>
                                ...
                                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="faulty_products" value="1"
                                        name="faulty_products" {{ old('faulty_products') ? 'selected' : '' }}>
                                ...
                                <div class="custom-control custom-checkbox my-1 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="quality_issue" value="1"
                                        name="quality_issue" {{ old('quality_issue') ? 'selected' : '' }}>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="sizecart" id="sizecart" rows="5"
                                    class="form-control summernote">{{ old('sizecart') }}</textarea>
                            </div>
                        </div>
