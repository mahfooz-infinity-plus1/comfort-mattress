...
<body>
    ...
    <div class="container">
        <div>
            <a href="{{ url('/') }}">
                <img src="{{ asset('assets/img/logo/logo.png') }}" alt="Comfort Mattress" />
            </a>
        </div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <div>
                    ...
                    <a href="mailto:info@comfort-mattress.com" title="info@comfort-mattress.com">info@comfort-mattress.com</a>
                </div>
            </div>
        </div>
    </div>
