...
<body>
    ...
    <div class="container">
        <div>
            <a href="{{ url('/') }}" title="Comfort Mattress">
                <img src="{{ url('/') }}/assets/image/logo/logo.png" alt="Comfort Mattress" />
            </a>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <hr>
                <div class="heading">
                    <h2>Hello! Comfort Mattress Team</h2>
                    <p>
