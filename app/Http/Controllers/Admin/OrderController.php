...
class OrderController extends Controller
{
    ...
    public function show($id, LogisticService $logistic)
    {
        try {
            ...
            // passing only order information not passing track_response information getting error
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            SMS::send($order->user->mobile, 'Comfort Mattress - Your Order ID : ' . $order->id . ', has been ' . $order->status . ',  Login for more detail on ' . route('user.login'));
    ...
    public function returnUpdate(Request $request, $id)
    {
        ...
        try {
            ...
            SMS::send($order->user->mobile, 'Comfort Mattress - Your Order ID : ' . $order->id . ', for Return and Refund is ' . $order->return_status . ',  Login for more detail on ' . route('user.login'));
