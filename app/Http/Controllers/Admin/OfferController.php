...
class OfferController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //     ]);
         ...
         $validator = Validator::make($request->all(), [
            'title' => 'required|string|unique:mst_offers,title',
            'code' => 'required|string|unique:mst_offers,code',
            ...
            'code.unique' => $request->code . ' Code Already Exists',
    ...
    public function update(Request $request, $id)
    {
        $validator = Validator::make($request->all(), [
            ...
            'title' => 'required|string|max:191',
            'code' => 'required|string|max:191|unique:mst_offers,code,' . $id,
            'type' => 'required|in:flat,percent',
            'value' => 'required|numeric|min:0',
            'min_order_amount' => 'nullable|numeric|min:0',
            'max_uses' => 'nullable|integer|min:0',
        ...
        [
            ...
            'value.required' => 'Enter Discount Value!',
