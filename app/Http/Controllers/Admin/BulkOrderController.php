...
class BulkOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Mail::send(['html' => 'backend.mails.enquiry'], ['data' => $data], function ($message) {
            $message->from('abhishekgupta5544@gmail.com', 'Comfort Mattress');
            $message->to('abhishekgupta5544@gmail.com', 'Comfort Mattress');
            $message->subject('New Bulk Order Enquiry From Comfort Mattress');
        });
