...
class LoginController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        SMS::send($user['mobile'], 'One Time Password (OTP) for Reset Password : ' . $rand_otp . ' Comfort mattress Note: this OTP is case sensitive, Do not Share your otp with anyone !');

        Mail::send(['html' => 'backend.mails.otp'], ['user' => $user], function ($message) use ($user) {
            $message->to($user['email'])->subject('Comfort Mattress, One Time Password(OTP)');
    ...
    public function resendOtp(Request $request)
    {
        if ($request->session()->has('user')) {
            ...
            SMS::send($user['mobile'], 'One Time Password (OTP) for Reset Password : ' . $user['otp'] . ' Comfort Mattress Note: this OTP is case sensitive, Do not Share your otp with anyone !');
