...
class UserController extends Controller
{
    ...
    public function returnOrder(Request $request, $id)
    {
        ...
        try {
            ...
            // SMS::send($order->user->mobile, 'Comfort Mattress - You have applied for Return and Refund against Order ID : ' . $order->id . ', Stay tuned for approval on ' . route('user.login'));
            ...
            Mail::send(['html' => 'backend.mails.ticket'], ['ticket' => $ticket], function ($message) use ($ticket) {
                ...
                $message->to($ticket->email, 'Comfort Mattress');
                // $message->bcc('comfortmattresses50@gmail.com', 'Comfort Mattress');
                $message->bcc('comfortlatexmattresses1959@gmail.com', 'Comfort Mattress');
                $message->subject('Comfort Mattress RE:' . $ticket->subject . ' Ticket ID : ' . $ticket->id);
            });
    ...
    public function cancelOrder(Request $request, LogisticService $logistic)
    {
        try {
            ...
            if ($orderCancel['status_code'] == 200) {
                ...
                // SMS::send($order->user->mobile, 'Comfort Mattress - Your Order ID : ' . $order->id . ', has been Cancelled successfully,  Login for more detail on ' . url('/'));

                Mail::send(['html' => 'backend.mails.order-cancel'], ['order' => $order], function ($message) use ($order) {
                    // $message->to('comfortmattresses50@gmail.com')->subject('Order has been Cancelled ! [order id : ' . $order->id . ']');
                    $message->to('comfortlatexmattresses1959@gmail.com')->subject('Order has been Cancelled ! [order id : ' . $order->id . ']');
                    $message->from('comfortmattresses50@gmail.com', 'Comfort Mattress');
                });
    ...
    public function orderHelp(Request $request, $id)
    {
        ...
        try {
            ...
            Mail::send(['html' => 'backend.mails.ticket'], ['ticket' => $ticket], function ($message) use ($ticket) {
                ...
                // $message->bcc('comfortmattresses50@gmail.com', 'Comfort Mattress');
                $message->bcc('comfortlatexmattresses1959@gmail.com', 'Comfort Mattress');
                $message->subject('Comfort Mattress' . $ticket->subject . ' Ticket ID : ' . $ticket->id);
            });
